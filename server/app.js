...
mongoose.connect('mongodb://admin:123456@ds039115.mongolab.com:39115/catta');

//var Document = mongoose.model('Document', { name: String, isbn: String, user: String });
//
//var doc = new Document({ name: 'van hoc 12', isbn:"dadadafasfwfa", user: "Thai"});
